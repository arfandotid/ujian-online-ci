			...
			<div class="box-body">
				<div class="mt-2 mb-3">
					<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-flat bg-purple"><i class="fa fa-plus"></i> Tambah Data</button>                <div class="row">
							...
							<?php if (isset($angkas)): ?>
								<div class="table-responsive">
									<table class="table table-bordered table-hover">
										<tbody>
											<?php for ($i=0; $i < intval($baris); $i++) { ?>
												<tr>
													<?php for ($j=0; $j < intval($kolom); $j++) { ?>
														<td><?php echo $angkas[$j][$i] ?></td>
													<?php }?>								
												</tr>
											<?php }?>								
										</tbody>
						...
						<div class="col-sm-8 col-sm-offset-2 mt-8">
		...
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<?= form_open('soal/addkraepelin', array('id', 'tambah')); ?>
