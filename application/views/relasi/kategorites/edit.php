    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                <?= form_open('kategorites/save', array('id' => 'jurusanmatkul'), array('method' => 'edit', 'matkul_id' => $id_matkul)) ?>
...
<script src="<?= base_url() ?>assets/dist/js/app/relasi/kategorites/edit.js"></script>