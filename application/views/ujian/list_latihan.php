<div class="row">
    <div class="col-sm-3">
        <div class="alert bg-green">
            <h4>Ruang<i class="pull-right fa fa-building-o"></i></h4>
            <span class="d-block"> <?= $mhs->nama_kelas ?></span>
        </div>
    </div>
    <div class="col-sm-3">
        <div class="alert bg-blue">
            <h4>Kategori Tes<i class="pull-right fa fa-graduation-cap"></i></h4>
...
<script src="<?= base_url() ?>assets/dist/js/app/ujian/list_latihan.js"></script>