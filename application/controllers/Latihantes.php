...
class LatihanTes extends CI_Controller
{
    ...
    public function list_jsons($latihan = '')
    {
        $this->akses_mahasiswa();
        $latihan = $latihan != '';
        $list = $this->ujian->getListLatihanTes($this->mhs->id_mahasiswa, $this->mhs->kelas_id, $latihan);
    ...
    public function list()
    {
        ...
        $data = [
            'user'         => $user,
            'judul'        => 'Latihan',
            'subjudul'    => 'List Latihan Tes',
            'mhs'         => $this->ujian->getIdMahasiswa($user->username),
        ];
        $this->load->view('_templates/dashboard/_header.php', $data);
        $this->load->view('ujian/list_latihan');
        $this->load->view('_templates/dashboard/_footer.php');
    }
