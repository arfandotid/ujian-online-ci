...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Jun 2022 pada 09.30
...
(1, '127.0.0.1', 'Administrator', '$2y$12$tGY.AtcyXrh7WmccdbT1rOuKEcTsKH6sIUmDr0ore1yN4LnKTTtuu', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1655359107, 1, 'Admin', 'Istrator', 'ADMIN', '0'),
(9, '::1', '999999999', '$2y$10$bJ8.GbyOsiY355uWguEBnupWn2lGuw7IKzWC9NsxQFIJgMR1oFu3C', 'sembilan@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1655313989, 1655364304, 1, 'Sembilan', 'Sembilan', NULL, NULL),
(10, '::1', '88888888', '$2y$10$KXj8dk7sNtVoTZ5LS4kX6Oy7FYfQdscgfMPMJZNfpEc.rKieqHhjW', 'anjasmara@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1655360546, 1655363330, 1, 'Anjasmara', 'Anjasmara', NULL, NULL);
...
ALTER TABLE `tb_soal_kraepelin`
  ...
  ADD CONSTRAINT `tb_soal_kraepelinci_online_test_ibfk_2` FOREIGN KEY (`dosen_id`) REFERENCES `dosen` (`id_dosen`);
